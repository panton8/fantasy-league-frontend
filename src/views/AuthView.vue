...
const handleLogin = async () => {
  try {
    error.value = ''
    const response = await fetch('http://127.0.0.1:8000/api/internal/v1/user/sign-in/', {
      method: 'POST',
      headers: {
...
const handleRegister = async () => {
  try {
    error.value = ''
    const response = await fetch('http://127.0.0.1:8000/api/internal/v1/user/sign-up/', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
