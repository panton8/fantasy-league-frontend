    ...
    <main class="main-content fantasy-main-flex">
      <div class="fantasy-squad-setup">
        <div class="squad-header">
          <div class="total-points">Сумма очков: <b>{{ totalPoints }}</b></div>
        ...
        <div class="squad-container">
          ...
          <div class="squad-section">
            <div class="squad-row" v-for="(row, rowIndex) in squadRows" :key="rowIndex">
              <div v-for="player in row" :key="player.id" class="player-slot">
                <div class="player-card">
                  <div class="position-label">{{ getPositionLabel(player.position) }}</div>
                  <img :src="player.t_shirt" :alt="player.surname" class="player-shirt">
                  <div class="player-info">
                    <span class="player-name">{{ player.surname }}</span>
                    <span class="player-points">{{ player.points }} очков</span>
                  </div>
                </div>
              </div>
            </div>
